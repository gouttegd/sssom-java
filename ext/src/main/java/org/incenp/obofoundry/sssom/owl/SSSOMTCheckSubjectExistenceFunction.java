 ...
 * <p>
 * That function may be used to drop any mapping whose subject does not exist
 * (or is obsolete) in the helper ontology. It does not take any argument.
 * 
 * @deprecated Maintained for backwards compatibility only. Use
 *             <code>!exists(%{subject_id}) -&gt; stop();</code> instead.
 */
@Deprecated
public class SSSOMTCheckSubjectExistenceFunction
    ...
    public String getName() {
        return "check_subject_existence";
    }
    ...
    public Mapping transform(Mapping mapping) {
        return app.classExists(mapping.getSubjectId()) ? mapping : null;
    }
}
