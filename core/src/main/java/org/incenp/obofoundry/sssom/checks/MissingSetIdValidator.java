 ...
 */
public class MissingSetIdValidator implements IMappingSetValidator {

    @Override
    public ValidationError validate(MappingSet ms) {
        if ( ms.getMappingSetId() == null || ms.getMappingSetId().isEmpty() ) {
            return ValidationError.MISSING_SET_ID;
        }
        return null;
    }
}
